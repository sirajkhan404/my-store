...
const All = () => {
    ...
    return (
        <div style={{ padding: '28px 24px', fontFamily: "'Inter', sans-serif", minHeight: '100%', background: '#f8fafc' }}>
            ...
            {/* ── Header ── */}
            <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:28, flexWrap:'wrap', gap:12, animation:'pr-in 0.4s ease' }}>
                <div>
                    <h1 style={{ margin:0, fontSize:24, fontWeight:800, color:'#0f172a', letterSpacing:-0.5 }}>🛍️ Products</h1>
                    <p style={{ margin:'4px 0 0', fontSize:13, color:'#94a3b8' }}>{documents.length} products in your store</p>
                </div>
                <button className="pr-add" onClick={() => navigate('/dashboard/products/add')}
            ...
            {/* ── Stat Cards ── */}
            <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fit,minmax(160px,1fr))', gap:14, marginBottom:24, animation:'pr-in 0.4s ease 0.05s both' }}>
                {[
            ...
            {/* ── Filters ── */}
            <div style={{ background:'#fff', borderRadius:16, padding:'14px 18px', marginBottom:18, boxShadow:'0 2px 10px rgba(0,0,0,0.05)', display:'flex', gap:10, flexWrap:'wrap', alignItems:'center', animation:'pr-in 0.4s ease 0.1s both' }}>
                ...
                <div style={{ marginLeft:'auto', fontSize:12, color:'#94a3b8', fontWeight:500 }}>{filtered.length} of {documents.length} products</div>
            </div>
            ...
            <div style={{ background:'#fff', borderRadius:20, boxShadow:'0 4px 20px rgba(0,0,0,0.07)', overflow:'hidden', animation:'pr-in 0.4s ease 0.15s both' }}>
                ...
                {/* Header */}
                <div style={{ display:'grid', gridTemplateColumns:'36px 56px 2fr 1.2fr 1.2fr 1.4fr 2fr auto', gap:0, background:'#1e293b', padding:'13px 20px', alignItems:'center' }}>
                ...
                {!loading && filtered.map((product, idx) => {
                    ...
                    return (
                        <div key={product.id} className="pr-row" style={{ display:'grid', gridTemplateColumns:'36px 56px 2fr 1.2fr 1.2fr 1.4fr 2fr auto', gap:0, padding:'14px 20px', alignItems:'center', borderBottom: idx < filtered.length-1 ? '1px solid #f1f5f9' : 'none', background:'#fff' }}>
                            ...
                            {/* Image */}
                            <div>
                                <div style={{ width:48, height:48, borderRadius:10, overflow:'hidden', border:'1.5px solid #f1f5f9', background:'#f8fafc', display:'flex', alignItems:'center', justifyContent:'center' }}>
                                    {product.imageURL
            ...
            {isModalOpen && productToEdit && (
                <div style={{ position:'fixed', inset:0, background:'rgba(15,12,41,0.6)', zIndex:1000, display:'flex', alignItems:'center', justifyContent:'center', padding:20, backdropFilter:'blur(4px)' }}
                    ...
                    <div style={{ background:'#fff', borderRadius:24, padding:0, width:'100%', maxWidth:600, maxHeight:'90vh', overflowY:'auto', boxShadow:'0 24px 64px rgba(0,0,0,0.18)', animation:'pr-in 0.3s ease' }}>
                        ...
                        {/* Modal Header */}
                        <div style={{ padding:'22px 28px 18px', borderBottom:'1px solid #f1f5f9', display:'flex', alignItems:'center', gap:14, position:'sticky', top:0, background:'#fff', zIndex:1, borderRadius:'24px 24px 0 0' }}>
                            <div style={{ width:44, height:44, borderRadius:12, background:'#ede9fe', display:'flex', alignItems:'center', justifyContent:'center', fontSize:20, flexShrink:0 }}>✏️</div>
                            <div style={{ flex:1 }}>
                            ...
                            <div style={{ marginBottom:20 }}>
                                ...
                                <div style={{ display:'flex', gap:8, marginBottom:10 }}>
                                    <input className="pr-input" type="text" value={editForm.imageURL} placeholder="Paste image URL (https://…)"
                                        ...
                                        style={{ ...inputStyle(formErrors.imageURL), flex:1 }} />
            ...
            {confirmDelete && (
                <div style={{ position:'fixed', inset:0, background:'rgba(15,12,41,0.6)', zIndex:1000, display:'flex', alignItems:'center', justifyContent:'center', padding:20, backdropFilter:'blur(4px)' }}
                    ...
                    <div style={{ background:'#fff', borderRadius:24, padding:32, width:'100%', maxWidth:380, boxShadow:'0 24px 64px rgba(0,0,0,0.18)', textAlign:'center', animation:'pr-in 0.3s ease' }}>
