import { DesktopOutlined, PieChartOutlined, TeamOutlined, DashboardOutlined, UserOutlined, BarChartOutlined, MessageOutlined, PlayCircleOutlined } from '@ant-design/icons';
...
export const items = [
    ...
    { key: "8", label: <Link to={`${root}/stories`} className="text-decoration-none">Stories</Link>, icon: <PlayCircleOutlined />, allowedRoles: ["superAdmin"] },
